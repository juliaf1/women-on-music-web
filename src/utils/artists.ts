...
const indiana: Artist = {
  id: "indiana",
  name: "Indiana Nomma",
  briefing: "Filha de pai baiano e mãe gaúcha exilados na década de 60, Indiana Nomma nasceu em Honduras e cresceu pelo mundo. Ela começou a estudar canto quando criança e, antes mesmo de completar vinte anos, já havia se apresentado no Carnegie Hall. Trabalhando com improviso e trompetes de boca, Indiana Nomma é cantora referente na cena do jazz.",
  city: "Honduras",
    ...
    videos: [
      {
        ...
        description: "'O vestido vermelho, o cabelo chanel e todo mundo cantando as músicas dela.' - Indiana Nomma tinha só quatro anos, mas nunca esqueceu o show da Mercedes Sosa que assistiu na final da campanha de alfabetização da Nicarágua. A força da presença de Mercedes no palco, com toda a plateia cantando junto, marcou a cantora na infância e influenciou sua trajetória.<br/><br/>Indiana conta sobre sua jornada, desde o primeiro show de Mercedes Sosa até o tributo que hoje presta em sua homenagem. A música de Indiana, marcada por influências latino-americanas e afro-brasileiras, reflete os elos que a cantora e instrumentista faz entre América Latina e Brasil, criando novas referências e mantendo viva a memória de Mercedes.",
      }
    ],
  },
  socials: {
    ...
    videos: [
      {
        ...
        description: "'O que é essa música brasileira que você tá querendo me mostrar?' - Vanessa Moreno narra a sua trajetória musical, que começou cedo absorvendo a música que a família tocava em casa, se transformou em amor pelo rock progressivo na adolescência e acabou em uma carreira de sucesso e muitos projetos na MPB.<br/><br/>Ela conta como entendeu que a música brasileira fazia parte dela, quando começou a estudar violão e dar nome às notas e sons que ouvia em casa, e como foi sua jornada desde então. Vanessa compartilha como faz suas escolhas musicais e reflete sobre a sua relação com o texto, o groove e o ritmo.",
      }
    ],
  },
  socials: {
    ...
    videos: [
      {
        ...
        description: "'Lá em casa, todo mundo tocava. Música era como respirar.' - Sandra de Sá é filha de baterista e nasceu em uma família de músicos. Para ela, música era como respirar, mas não o que ela se imaginava trabalhando.<br/><br/>Parece difícil pensar que a compositora de músicas tão marcantes não ia seguir esse caminho, mas ela quase terminou a faculdade e só não seguiu carreira como psicóloga, porque seus amigos começaram a inscrevê-la em diversos festivais de música.<br/><br/>Sandra conta da sua trajetória e como a música e a arte marcaram sua vida.",
      }
    ],
  },
  socials: {
    ...
    videos: [
      {
        ...
        description: "'Meus pais pediram um filho cantor. Nasceram sete!' - Evinha nasceu em uma família de artistas. Ela é irmã de Ronaldo, Roberto e Renato, dos Golden Boys, e de Mario, Regina e Marizinha, do Trio Esperança. Os dois grupos marcaram os anos 60, chegando a se apresentar no programa da Jovem Guarda.<br/><br/>Evinha narra a sua trajetória pessoal e musical, relembrando momentos chave da sua jornada, como o lançamento de Casaco Marrom e a turnê do Trio Esperança em 1990. Além de contar sobre os reencontros musicais da família.",
      }
    ],
  },
  socials: {
    ...
    videos: [
      {
        ...
        description: "'Ele chegou no Beco das Garrafas e disse assim: fiz uma música, porque vocês estão botando muito jazz na bossa nova.' - Leny reconta quando Carlos Lyra compôs Influência do Jazz.<br/><br/>Para a cantora e pianista, que hoje é referência em samba-jazz no mundo, o desconforto do colega com a influência que o jazz norte-americano passava a ter no gênero brasileiro foi motivo de graça. Isso porque, a música brasileira existe em condição multicultural - com fortes influências portuguesas, ameríndias, africanas e, também, americanas do jazz.<br/><br/>Leny topa gravar a composição, mas a transforma, com sua voz e os arranjos de Tenório Júnior, em uma grande celebração da mistura brasileira e da fusão jazz, samba e bossa nova.",
      }
    ],
  },
  socials: {
    ...
    videos: [
      {
        ...
        description: "'Chiquinha era emporada. Ô mulher empoderada.' - Maria Teresa reconta uma conversa que teve com sua filha, reconhecendo e celebrando os avanços das mulheres na conquista de mais espaços, que a levou a refletir sobre a força de Chiquinha e toda a sua jornada.<br/><br/>Desde a formação musical erudita até o envolvimento com a música popular, Chiquinha Gonzaga atravessou dificuldades, mas manteve-se firme fazendo o que acreditava. Essa força é influência para outras artistas mulheres.<br/><br/>Além de contar sobre a trajeteoria de Chiquinha, Maria Teresa também recorda a sua participação como diretora musical no Forrobodó, revista-musical de Chiquinha - projeto que a abriu muitos caminhos.",
      }
    ],
  },
  socials: {
